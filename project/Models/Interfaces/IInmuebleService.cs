namespace project.Models.Interfaces
{
    public interface IInmuebleService
    {
        ...
        public Task<(string?, List<Inmueble>?)> ObtenerTodosLosInmuebles(int paginaNro = 1, int tamPagina = 10,bool? disponibilidad = null ,int? dniPropietario = null,string? uso = null, string? tipoInmueble = null, int? cantidadAmbientes = null, int? precio = null,DateOnly? fechaDesde = null, DateOnly? fechaHasta = null);
