...
-- Base de datos: `inmo`
--
CREATE DATABASE IF NOT EXISTS `inmo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `inmo`;
...
(21, 'Máximo', 'quiroga', 44642650, '02664954151', 'maxiquiroga2121@gmail.com', 'Barrio 125 manzana 29 casa 17', 1),
(22, 'Máximo', 'quiroga', 30123451, '02664954151', 'maxiquiroga212111@gmail.com', 'Barrio 125 manzana 29 casa 17', 1);
...
--
ALTER TABLE `tipo_inmueble`
  MODIFY `id_tipo_inmueble` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
